 ...
 * [VFB_NT.yml](VFB_NT.yml)
     * Determines how your purl.obolibrary.org/obo/VFB_NT/ redirects will be handled
     ...
     * Paste in the contents of [VFB_NT.yml](VFB_NT.yml)
 ...
 * [VFB_NT.md](VFB_NT.md)
     ...
     * Paste in the contents of [VFB_NT.md](VFB_NT.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
